...
To produce a release build, supply your own signing key in `credentials/keystore.json` and
run the Gradle release task. The previous project's keystore is **not** in this repository
and never was; release builds on a fresh clone are debug-signed until you add your own key.
...
**[5073340abdulrehmankhandurrani@gmail.com](mailto:5073340abdulrehmankhandurrani@gmail.com)**
so it can be addressed promptly. Note that this repository contains source code only —
takedown requests concerning media content should be directed to the platform actually
hosting that content, not here.
